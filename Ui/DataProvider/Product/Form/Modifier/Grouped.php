...
class Grouped extends \Magento\GroupedProduct\Ui\DataProvider\Product\Form\Modifier\Grouped
{
     ...
     * @param Status $status
     * @param AttributeSetRepositoryInterface $attrSet
    ...
    public function __construct(
        ...
        Status $status,
        AttributeSetRepositoryInterface $attrSet,
        ...
        $dependencies = [$locator, $urlBuilder, $productLinkRepo, $productRepo, $imageHelper, $status, $attrSet];
        $dependencies2 = [$localeCurrency, $uiComponentsConfig, $groupedProducts, $productLinkFactory, $helper];
        parent::__construct(...$dependencies, ...$dependencies2);
    }
