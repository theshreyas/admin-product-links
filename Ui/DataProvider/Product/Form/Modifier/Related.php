...
class Related extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\Related
{
    ...
    public function __construct(
        ...
        $dependencies = [$imageHelper, $status, $attributeSetRepository, $scopeName, $scopePrefix];
        parent::__construct($locator, $urlBuilder, $productLinkRepository, $productRepository, ...$dependencies);
    }
